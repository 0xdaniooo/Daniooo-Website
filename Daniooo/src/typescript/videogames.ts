...
let itemObjects: Game[] = [
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "This being a third person 3D game introduced a lot of unseen complexity, certainly something I had no experience with. I had to learn a third person camera package, get the animations to work with controls and allow for context switching between the player and the drone - all without any hiccups or dual control of both at the same time. I got a new laptop around this time so development was a lot more enjoyable since the old one was fully on its last breath." },
            { type: "paragraph", text: "I dived deeper into abstraction for generalised environment interactions and expanded this to the abilities the player would use both on their character and the drone. Realism was also something I had been aiming for and so the projectiles needed to have a balance of deadliness and physics. Finally, the environment was something to be exploited as well through destructible trees and exploding barrels - this could work either for or against you." },
            ...
            { type: "paragraph", text: "I've considered developing this game properly from the ground up so many times in recent years. I've had a full plan developed for the mechanics, aesthetic and development. Later a story and a Soviet based atmosphere surfaced up with time. The game idea itself is solid but the problem is that game production is so involved and I don't have the time to pull this off in accordance with my vision. This however would later unexpectedly materalise as a concept for a book..." },
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "Things would take a different turn as Covid was beginning to emerge into the world. We had a progress week in early March meaning we only came in for a quick checkup meeting then had the rest of that week off. That would be the last day we saw each other as our teachers were infected themselves shortly after and then the country went into lockdown. My personal laptop was very underpowered and so I had to switch to 2D using my first ever game as reference which was a shame." },
            { type: "paragraph", text: "The Covid lockdown in general was actually amazing for me: just doing work remotely listening to Spotify all day long not having to commute anywhere. I always had the belief that I wasn't creative but doing those Photoshop sprites and animation frames was so much fun. I got to chat with friends more on a Discord server I had created whilst working on a game I felt passionate about - it truly didn't even feel like work and that was the happiest I had been in a while." },
            ...
            { type: "paragraph", text: "My programming experience had also reached a point where I felt quite comfortable working on more complex mechanics such as dynamically instantiated enemies with healthbars and an inventory system. By now I had enough experience to grasp the basics and begin unravelling online scripts to fit my purpose exactly how I wanted them to. Then we got the unfortunate news to abandon this project, that instead we'd be graded on our past work." },
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "Second year of college had begun and it was a new start. The world had felt different with the pandemic still rampant as we had to wear masks to lessons now and we got new teachers which seemed to be a lot more experienced and actually taught us stuff. This time around we had a much more structured and engaging curriculum exploring topics like lighting, level design, enemy design even 3D modelling (I learnt blender and it was so intuitive)." },
            { type: "paragraph", text: "What I loved was how we actually dived deep into game development and this encouraged us to go further. Development had only begun after Christmas with the time prior to that spent learning all these fundamentals. Our only constraint here was to develop something that was to be played in first person hence the name. Having been playing a lot of Cyberpunk 2077 when it released and being a massive fan of Fallout New Vegas I combined the two for a futuristic game set in Area 51." },
            { type: "image", src: "/content//historic/FPEworld.webp", caption: "Original level design blockout [January 2021]" },
            ...
            { type: "paragraph", text: "My creative skillset had improved so much so coupled with the extensive research I had done, I created a world that looked stunning (at least to my own eyes). I even learnt how to create character models and rig them with AI for animations using Adobe Mixamo. Experimenting with navmesh meant I had realistic enemies which made the game feel that much more polished. There was a lot of work at each stage but I was more than happy to continue pushing myself further to get everything in place." },
            ...
            { type: "paragraph", text: "After a year of programming I was so much more comfortable with development, enabling me to implement a quest line, interactions with the environment using abstraction, navmesh intelligent AI and even little mechanics like an FOV slider. How I pulled this off on my 4GB RAM Celeron notebook from 2015 I have no idea but that was all I had with lessons now being conducted online via Teams calls. That thing was barely usable yet I was capable of creating something that felt very comprehensive and it was a massive achievement for me. I even went into intense crunch from 9am-23pm on the last day just to finish it all off how I wanted it to be. The game itself may not be unique but the work that went into this still makes me proud to this day." },
        ],
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "Shortly after finishing high school and enrolling into college (UK so I was only 16 at the time) I had my very first introduction to game development and programming. I had known I wanted to work with computers since probably around 8 years old so my two options were either game development as I loved gaming or IT which unfortunately I did not get accepted for. Despite my love for technology, I wasn't exactly good at it and truthfully my only experience thus far was with image editing so that at least covered me partially for what was about to come." },
...
function createHTMLitem(item: Game)
{
    ...
    else itchIOLink.textContent = 'Play now on Itch IO';
    ...
    if (item.devlog.length != 0) footerColDiv.appendChild(devlogButton);
    if (item.github.length != 0) footerColDiv.appendChild(githubButton);
