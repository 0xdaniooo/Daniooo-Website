...
let itemObjects: Software[] = [
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "After completing my portfolio website and beginning to feel more comfortable with web development, I began raising the stakes. I needed a project that would challenge me and this was it. We originally found the missing piece to completing this project once we were done with development and that was to use AJAX but it was too late at that point. This would be my starting point." },
    ...
    },
    {
        ...
        title: "Daniooo Website | Eleventy, SCSS, TypeScript and Bootstrap Website",
        description: "My personal website (the one you're looking at now) built with Eleventy, SCSS, TypeScript and Bootstrap 5 where I host all my content in one convenient place.",
        ...
        history: [
            ...
            { type: "paragraph", text: "Once I had finished Planify at the end of my second year I went straight to work updating my portfolio site. The colour scheme itself had stayed virtually the same however the architecture would be completely overhauled - each section would be housed on its own page. The second major point was that I would put as much effort as possible into making navigation enjoyable. This meant engineering various little UX features like a progression slider and highlighting anything that was clickable with a red tint." },
            { type: "paragraph", text: "In this process I got to polish my Bootstrap experience and styling knowledge. Perfection is unattainable however I wanted to get this as close to my vision as possible with no compromises no matter how long it would take. Fortunately, I had improved my skillset dramatically since the first iteration so it wasn't too difficult to get an idea then get it implemented immediately. I wanted to create something that felt uniquely mine and so allowed myself to experiment with little features eg the breadcrumbs for a more personal touch. The core idea was that I would build a strong foundation that would not need any major redesigns later down the line, something that would keep me satisfied and that's exactly what's happened." },
            ...
            { type: "paragraph", text: "Since the redesign, I have been constantly optimising and innovating the site every few months. This happens either when I get new ideas or I finally find a way to execute ideas I couldn't implement previously. Quite a large effort has been put in place to optimise the performance through changing all the media to .webp files, significantly saving on bandwidth. Other big changes include icons displayed on software and videogame projects + articles, multiple Spotify playlists on the about me page, the new backstory functionality for projects and many rewrites to simplify the codebase. I had also integrated Eleventy into the workflow to allow me to use templates and reduce repetition. Features come and go but in the process I become a much better developer and allow myself the space to try out new ideas since this is the only project I've maintained after initial creation. It's come a long way since its inception and will only continue to become more refined." },
        ],
        ...
        icons: ["bootstrap", "eleventy", "ts", "scss"]
    },
    {
        id: "habit-tracker",
        ...
        history: [
            ...
            { type: "paragraph", text: "This originally started as a tool I made just for my own use. I had been tracking habits on paper for a good few years but the manual admin work was getting tedious plus I wanted a way to see my long-term progression at a glance. I’ve always loved seeing my coding progress stack up on GitHub so the insight hit me to try and emulate that exact visual reward system for my daily life. The basic version was effective enough that I decided to flesh it out into a proper tool, expand it with more features and make it available to others." },
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "Originally I did all my development using C# WinForms. I had never developed a GUI before and so defaulted to C# as I had prior experience using that for my college videogames so there was that visual association. I managed to get the functionality working but doing so through Visual Studio was such a horrible experience with things breaking and not being able to delete references reliably. I needed an alternative, something that wouldn't make development so miserable. Tkinter had come up in my conversations with friends in the past so I finally decided to look into it. After some quick research it proved to be a lot easier than WinForms and so without a second thought I got to work porting the codebase." },
            ...
            { type: "paragraph", text: "Sure enough development became much easier once I switched to Tkinter and I had the added benefit of learning more about Python. Visually it was a bit limited and I spent a ton of time digging through documentation to learn how to make it look the way I wanted but I had a lot of fun having also been rewatching Mr Robot at the time which put me in a very focused frame of mind. In the end I was happy to create a tool that actually worked pretty nicely and illustrated the idea so well - I couldn't have expected that my venture into algorithms would lead me towards the low level workings of computers which then translated itself into an interactive training tool." },
        ],
    ...
    },
    {
        ...
        history: [
            ...
            { type: "heading", text: "Old ideas resurfacing" },
            { type: "paragraph", text: "Whenever I needed to travel, I found myself repeatedly jumping between dates, routes and airlines - recording these prices through a manual process I had grown accustomed to. That tedious repetition ate away at me and I hated it. I had explored the idea of automation in the past through a bot however captchas and the absence of official APIs quickly made that route impractical so I scrapped it. Rather than abandon the idea altogether, I shifted focus toward building something that could at least remove the most painful parts of the process." },
            { type: "heading", text: "SecPass proof of concept" },
            { type: "paragraph", text: "Throughout development I got to see how these sites behaved internally, learning how to extract structured data from what was never designed to be human friendly. The project however also doubled as a proof of concept to test whether SecPass was even viable to develop in the first place (which I was glad to learn was the case). I had never created browser extensions so this gave me the chance to see how these are put together and how much functionality they offer. Eventually I had to cast it aside temporarily to focus on my final year of uni and all the assignments I had on my plate though much of the initial footwork had now been done." },
            ...
            { type: "paragraph", text: "Uni was complete so I made a return to development. After some time, I finally had a way of extracting my desired information (and more) rapidly through a single keybind. There's always different ways to look at travel decisions; a cheaper ticket isn't really cheaper if you pay more to get to the airports themselves which is precisely why I wanted all data to be sortable. Having been developing closed source projects with aims of monetisation, I decided to publish this extension and therefore needed it to be usable on major browsers with those being Firefox, Chrome and Edge. This meant conforming properly to manifest standards and browser dependant APIs then going through their particular publishing processes. I had plans to monetise this but I dropped those as there wasn't much incentive to do so, leaving this as one of my (possibly?) last open source projects for a long time to come..." },
        ],
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "At the time, I had taken a break from programming to upskill myself more in the realm of cybersecurity and to try and find what career I'd like to go into. I'd find that reverse engineering ticked all the right boxes so I spent the summer doing many challenges on [https://crackmes.one/]. This website thus came as a random idea, having wanted to get back into coding. I had spent a lot of time debugging ELF binaries with GDB, inspecting memory and translating hexcode bytes to human-readable information. This required me to keep note of various conversion sites, each one for a specific purpose. Maybe I could do something with this..." },            
            ...
            { type: "paragraph", text: "This was my first introduction to web development. While I had technically worked on the original Planify for a team project at the start of the year, I had not touched much of the frontend which was the part that intimidated me. I had always weirdly thought it above me and that I'd never be capable of making sense of all the HTML syntax and the mess that is CSS. This ended up being a very quick project, having barely taken any time to complete but the effect was that I now had web development under my belt and realised it wasn't anything difficult at all." },
        ],
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "My main interest in C++ had been sparked by my game development days back in college. Being a Unity developer I was accustomed to C# whereas it seemed all the game companies used C++ for their games. This coupled with the involved nature of the language made me very eager to try it out. I started out by following tutorials but the knowledge came in one ear and went out the other so I decided to model a real-world system that I already understood: a bank. It gave me a clear blueprint for the components I'd need to implement with these being accounts, balances and transactions." },
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "May was quite a social month with me playing poker regularly with friends and family. This came with quite a steep learning curve and so it bugged me that I wasn't making sense of poker - something that ate away at me until I began studying the rules in depth. That would turn into a desire to actually understand what was happening at every stage of a round: from dealing and betting to turn order and win conditions. My game developer background would lead me to translate this into code I could understand and manipulate on a lower level." },
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "Another of my dry spells had come as I had nothing interesting to develop. For a long while I had been using [https://untroubled.org/pwgen/ppgen.cgi] to generate my passphrases where I would edit each one before using it to add some permutations of my choice. For this solution, I focused on automating the modifications that I performed on these passphrases like adding numbers, special characters and substitutions to reinforce them with additional strength and compliance. This would be my introduction to website HTML retrieval as this would be the best method of interfacing with the webpage, sparing me the need to develop the foundation when I could make use of the exact tool I had come to trust." },
    ...
    },
    {
        ...
        history: [
            { type: "heading", text: "Timeframe" },
            { type: "paragraph", text: "Development started in April 2022 - ended in April 2022" },
            { type: "heading", text: "For the portfolio" },
            { type: "paragraph", text: "The first year of university had come to a close and I had nothing to work on. I had just finished my bank system project meaning I wanted to continue the momentum and build myself up more, having seen just how easier it was to learn programming and languages through these projects. In retrospect, this little insignificant program would kickstart my passion for developing personal projects outside of the academic realm and would lead to the lenghty portfolio that I have now." },
            { type: "heading", text: "Introduction to Python" },
            { type: "paragraph", text: "Sure I had used Python in my uni course but I never had a chance to play around with it myself, adapt it to my use cases. I created a few little games by following tutorials right before this which primed me with the general structure of .py files. I then got to work creating this little calculator so I could get my 1st year university grades before they were released to us. I got it done that same day but nevertheless I was left with a positive impression and had another bit of work to call my own - setting a pattern for the months to come." },
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "netOS was originally supposed to be a ctOS simulator inspired by Watch Dogs, the game that got me into cybersecurity. I was lost as to what my next project should be, trying to catch some sleep when I had the realisation that I could try developing a tool which allows you to control city infrastructure just like in the game but on a more technical scale. Django was the obvious best candidate as I had already built up a great amount of experience and had decided trying other GUI packages could prove to be too complex. Back in 2022 I attempted a similar project using C++ which would be CLI based though I could not understand abstraction and other concepts necessary for its execution, instead opting to learn the basics in my Bank System app." },
            ...
            { type: "paragraph", text: "Unfortunately seeing as I'm hoping to monetise this I can't reveal more information on the visuals, features and the code itself as I'd be exposing too much of the idea. This project has been in the works for a quite a while and it'll likely stay this way for the foreseeable future - there's just so much to do. Work is pretty sporadic; we pick it up for a few weeks, make some great progress then life takes over again. The silver lining however is that I often come back with new knowledge I have learnt in other endeavors which I can insert into netOS to strengthen it even more." },
    ...
    },
    {
        ...
        history: [
            ...
            { type: "paragraph", text: "Going into final year, I had absolutely no idea what I wanted to build. Everyone around me seemed to arrive with a crystal clear idea while I was completely directionless, stuck knowing I had to commit to something substantial without having any real conviction behind any one idea. There was netOS but I would not be able to pull off something of that scale in such a short space of time (not to mention how I wanted to retain full control over this enterprise) so it became a no-go." },
            { type: "paragraph", text: "That changed entirely during the FYP induction lecture when the concept of a password manager hit me with visceral clarity. As soon as I got home, I drafted up the first design document while the idea was still fresh in my head. This idea was simple: an intuitive password manager with a server relay for syncing data and a deep red black aesthetic. I even found a perfect emoji (flower card, Notion variant 🎴) to represent the colour scheme I had pictured and I stuck to this up until I had developed my logo and UI designs." },
            { type: "paragraph", text: "Inspiration had been taken from Myki. This was a password manager I had used daily for my credentials and note taking before it was suddenly discontinued early 2022, leaving behind a noticeable gap that nothing else really seemed to fill properly. Finally I had something that I felt strongly for and could dedicate time to making it happen." },
            ...
            { type: "paragraph", text: "Conceptually, my ambition was far greater than what I could realistically deliver at the time. To pass the module, we had to produce a lengthy report of around 8000 words on top of creating a related software solution. My preference lies in solution development however even that proved to be difficult as I couldn't find the motivation to get anything moving other than spinning up ideas in my mind about how this could be molded into my ideal product. To add to the fun, I had various other highly involved modules ongoing alongside part-time work and learning to drive - I bit off more than I could chew. " },
            { type: "heading", text: "Proof of concept" },
            { type: "paragraph", text: "The start of 2025 led to a situation where I more or less forced myself to bring the browser extension aka the password manager itself to fruition. Originally, the plan was for the extension to communicate with a backend relay server that would handle synchronisation and vault operations but there simply wasn’t time to design and implement that entire layer properly. All I managed to complete on the backend side was a basic authentication system for login and signup. The extension alone consumed an enormous amount of time just to make it stable, usable and presentable enough for the demo not to mention the heavy amount of research that shadowed its creation." },
            { type: "paragraph", text: "Despite how bare bones the final submission was compared to the original vision, it brought forth a valuable conclusion. It proved that the idea was technically viable, even if it was heavily stripped back. Since then, I’ve picked the project back up with a different mindset — I’m now working towards getting the extension to properly communicate with the server exactly as I originally intended. The goal now is simply to produce a complete proof of concept of the original vision and demo the completed work." },            
            { type: "paragraph", text: "Given that this project was originally developed as part of my dissertation, I have chosen to keep the codebase private (for infringment and sentimental reasons). Moreover, I'm leaving the possibility open that one day I may return to it and try to execute it however given how much security proofing that would require and my netOS project taking precendance that's unlikely to happen. Myki followed a model where the vault was stored on a mobile or desktop app and communicated to the extension or relay; the storage mechanisms used for browser extensions are just way too volatile making this merely a prototype and a bittersweet memory of my final year of university." },
...
function createHTMLitem(item: Software)
{
    ...
    if (item.video.length != 0)
    {
        ...
        playButton.setAttribute('class', 'video-overlay d-flex flex-column justify-content-center align-items-center');
        playButton.innerHTML = `
            <div class="play-btn-wrapper">
                <i class="fa-brands fa-youtube play-icon"></i>
            </div>
            <div class="watch-video p-2 px-3 mt-3">
        ...
        cardDiv.addEventListener('click', () => {
            ...
            // Hide iframe visually while it loads
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    handleHashRouting((targetId, openModal) => {
        if (openModal) openProjectModal(targetId, itemObjects);
    });
});